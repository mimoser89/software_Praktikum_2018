...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.authorizeRequests()
			.antMatchers("/", "/connect**", "/webjars/**", "/login*", "/registration", "/selectRole").permitAll()
			.antMatchers("/login/investor_make_investments*", "/login/investor_my_investments*").authenticated()
			.antMatchers("/login/addRoof*", "/login/owner_my_roofs*", "/login/roofOwner*", "/login/roofSuccess*").authenticated()
			.and().formLogin()
