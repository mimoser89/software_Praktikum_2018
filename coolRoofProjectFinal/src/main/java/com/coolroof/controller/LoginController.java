...
public class LoginController {
	...
	public ModelAndView defaultAfterLogin() {
		...
		if (user.getRole().equals("roofOwner")) {
			modelAndView.setViewName("redirect:/login/addRoof.html");
			return modelAndView;
			
		}
		
		modelAndView.setViewName("redirect:/login/investor_make_investments.html");
		return modelAndView;
	}
	
	@RequestMapping(value = "/login/failurePage", method = RequestMethod.GET)
	public ModelAndView failurePage() {
		
		ModelAndView modelAndView = new ModelAndView();
		modelAndView.setViewName("login/failurePage");
		return modelAndView;
