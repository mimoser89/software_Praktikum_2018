...
public class LoginController {
	...
	public String defaultAfterLogin() {
		...
		return "redirect:/admin/investor.html";
	}

	private User getSocialMediaUser() {
	...
	@RequestMapping(value = "/admin/investor", method = RequestMethod.GET)
	public ModelAndView investor() {
		ModelAndView modelAndView = new ModelAndView();
		...
		modelAndView.setViewName("admin/investor");
		return modelAndView;
	}
